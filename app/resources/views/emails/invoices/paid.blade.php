                        ...
                        <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:20px; padding-bottom:20px; padding-right: 0px; padding-left: 0px;">
                            ...
                            <div style="color:#0068A5;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:16px;line-height:18px;text-align:left;color:#000;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                    ...
                                    <p style="margin: 0;font-size: 16px;line-height: 18px;text-align: left">
                                        Your invoice {{ $invoice->invoice_no }} with a total NGN {{  number_format($invoice->total,2) }} has been paid. The invoice status will automatically updated.
                                    </p>
                                    <p style="margin: 0;font-size: 16px;line-height: 18px;text-align: left">
                                       Thank you for using Bridgebooks.
                                    </p>
                                </div>
                            ...
                            <div align="center" class="button-container center" style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;">
                                ...
                                <a href="{{ $params['url'] }}" target="_blank" style="display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #0068A5; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 200px; width: 140px; width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 30px; padding-bottom: 5px; padding-left: 30px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;mso-border-alt: none" target="_blank"><span style="font-size:12px;line-height:24px;"><span data-mce-style="font-size: 16px;" style="font-size: 16px; line-height: 32px;">View Invoice</span></span></a> <!--[if mso]></center></v:roundrect></td></tr></table><![endif]-->
                            </div>
                            <div style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <!--[if (mso)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px;padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0"><tr><td><![endif]-->
                                <div align="center">
                            ...
                            <div style="color:#555555;line-height:120%;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;color:#555555;text-align:left;">
                                    <p style="margin: 0;font-size: 12px;line-height: 14px"><span style="font-size: 14px; line-height: 16px;">If you have any questions you can contact us at <a href="mailto:support@bridgebooks.ng">support@bridebooks.ng</a></span></p>
                                </div>
                            </div><!--[if mso]></td></tr></table><![endif]-->
                            <!--[if (!mso)&(!IE)]><!-->
                        </div><!--<![endif]-->
