                                        ...
                                        <div style="color:#0068A5;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;text-align:center;color:#000;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                <p style="margin: 0;font-size: 16px;line-height: 18px;text-align: left">
                                                    Hello {{ $slip->employee->first_name }},
                                                </p>
                                                <p style="margin: 0;font-size: 16px;line-height: 18px;text-align: left; padding-top: 15px;">
                                                    Find attached your payslip for {{ date("d M, Y", $slip->payrun->start_date->getTimestamp()) }} - {{ date("d M, Y", $slip->payrun->start_date->getTimestamp()) }}.
                                                </p>
                                            </div>
