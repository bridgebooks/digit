...
return [
    ...
    */
    ...
    'frontend_url' => env('FRONTEND_URL', 'http://localhost:4040'),
    ...
    |--------------------------------------------------------------------------
    |
    | This URL is used to validate user accounts
    |
    */
    ...
    */
    ...
    'default_subscription_plan' => env('DEFAULT_PLAN', 'pro'),
    ...
    */
    ...
    'trial_duration' => env('TRIAL_DURATION', 30),
